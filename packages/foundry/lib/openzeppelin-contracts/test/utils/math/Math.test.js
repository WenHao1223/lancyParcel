	...
	describe("mulDiv", function () {
		...
		describe("does round down", function () {
			...
			it("large values", async function () {
				for (const rounding of RoundingDown) {
					expect(await this.mock.$mulDiv(42n, ethers.MaxUint256 - 1n, ethers.MaxUint256, rounding)).to.equal(
						41n,
					);
					...
					expect(
						await this.mock.$mulDiv(ethers.MaxUint256, ethers.MaxUint256, ethers.MaxUint256, rounding),
